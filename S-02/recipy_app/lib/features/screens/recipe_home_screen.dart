...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late Future<Either<Failure, List<MealModel>>> _mealsFuture;
  ...
  void initState() {
    ...
    _mealsFuture = _mealsRepo.getCategoryMeals(category: _selectedCategory);
  }
                            ...
                            return ChoiceChip(
                              ...
                              onSelected: (_) {
                                if (category.strCategory != null) {
                                  _onCategorySelected(category.strCategory!);
                                }
                              },
                            );
                          },
